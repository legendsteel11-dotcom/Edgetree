  ...
  ko: {
    ...
    features: {
      ...
      items: [
        ...
        { title: '파일 종류 필터', desc: '하단 바에서 코드·이미지·문서·미디어 등 트리에 보일 파일 종류를 선택합니다. 원하는 확장자를 하나 또는 여러 개 직접 지정할 수도 있습니다. 검색은 필터로 걸러진 파일도 찾습니다.' },
        ...
        { title: '폴더 숨기기', desc: '잘 안 쓰는 폴더나 드라이브를 우클릭 한 번으로 트리에서 감춥니다. 감춘 것은 목록에 모여 있어 하나씩 또는 한 번에 되돌릴 수 있고, 검색은 감춘 폴더 안도 그대로 찾습니다.' },
  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { title: 'File Type Filter', desc: 'Pick the file kinds the tree shows from the bottom bar - code, images, documents, media and so on. You can also type in your own extensions, one or several. Search still finds the files the filter is hiding.' },
        ...
        { title: 'Hide Folders', desc: 'Take a folder - or a whole drive - out of the tree with one right-click. Hidden ones collect in a list to be brought back one at a time or all at once, and search still reaches inside them.' },
